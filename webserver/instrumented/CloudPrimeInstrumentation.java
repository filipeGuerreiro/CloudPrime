...
public class CloudPrimeInstrumentation {
     ...
     * instruments only IntFactorization, and outputs it to the specified output
     * directory.
     */
        ...
        for (int i = 0; i < infilenames.length; i++) {
            ...
            if (infilename.equals("IntFactorization.class")) {
                ...
                for (Enumeration e = ci.getRoutines().elements(); e.hasMoreElements();) {
                    ...
                    // when calcPrimeFactors finishes, method factorize is called and prints result
                    // to file
    ...
    public static void LSCount(int nil) {
        ...
        if (loadCount > METRIC_THRESHOLD) {
            sendMetrics(loadCount);
        }
    }
    ...
    private static void sendMetrics(long loadCount) {
        ...
        if (_registeredLoad[index] == 0L) {
            _mss.updateMetrics(load);
        } else {
            _mss.updateMetrics(load - _registeredLoad[index]);
        }
