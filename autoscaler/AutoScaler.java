...
public class AutoScaler {
	...
	protected static Instance launchNewInstance() {
		...
		runInstancesRequest.withImageId(Constants.WEBSERVER_AMI_ID).withInstanceType("t2.micro").withMinCount(1)
				.withMaxCount(1).withKeyName(Constants.KEY_PAIR_NAME).withSecurityGroups(Constants.SECGROUP_NAME)
				.withMonitoring(true);
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			TimerTask increasePolicy = new IncreaseGroupPolicy(Constants.INCR_POLICY_ID);
			TimerTask decreasePolicy = new DecreaseGroupPolicy(Constants.DECR_POLICY_ID);
