...
public class AmazonDynamoDB {
    ...
    public static void init() throws Exception {
        ...
        try {
            ...
            if (Tables.doesTableExist(_dbClient, TABLE_NAME)) {
                ...
                // Create a table with a primary hash key named 'PRIMARY_KEY', which holds a
                // string
                CreateTableRequest createTableRequest = new CreateTableRequest().withTableName(TABLE_NAME)
                        ...
                        .withAttributeDefinitions(new AttributeDefinition().withAttributeName(PRIMARY_KEY)
                                .withAttributeType(ScalarAttributeType.S))
                        .withProvisionedThroughput(
                                new ProvisionedThroughput().withReadCapacityUnits(1L).withWriteCapacityUnits(1L));
                TableDescription createdTableDescription = _dbClient.createTable(createTableRequest)
                        .getTableDescription();
    ...
    public static void putItem(String webserverIP) throws AmazonServiceException, AmazonClientException {
        ...
        Item item = new Item().withPrimaryKey(PRIMARY_KEY, webserverIP)
    ...
    public static void updateMetrics(String webserverIP, long load) {
        ...
        UpdateItemOutcome outcome = table.updateItem(PRIMARY_KEY, webserverIP, "set #A = #A + :val1", // UpdateExpression
                expressionAttributeNames, expressionAttributeValues);
    }

    /*
     * Gets all the load values from each thread for that webserver. Used by
     * loadbalancer to determine total load on that webserver.
     */
    public static List<WebserverInfo> getAllMetrics() throws Exception {
        ...
        /*
         * for (WebserverInfo ws : scanResult) { System.out.println(ws); }
         */
        return scanResult;
    }
